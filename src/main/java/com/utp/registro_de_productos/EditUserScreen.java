...
public class EditUserScreen extends javax.swing.JFrame {
    ...
    public EditUserScreen(UserModel user) {
        ...
        employeeComboBox.getModel().setSelectedItem(user.getEmployee());
        adminRadioButton.setSelected(user.getIsAdmin());
        notAdminRadioButton.setSelected(!user.getIsAdmin());
    }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        int option = JOptionPane.showConfirmDialog(null, "¿Está seguro de editar este usuario?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (option == JOptionPane.YES_OPTION) {
            ...
            Either<String, String> response = new UserController().onEdit(user);
            if (response.isRight()) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditUserScreen(new UserModel()).setVisible(true);
            }
        });
    }
