 ...
 */
public class AddCategorySreen extends javax.swing.JFrame {
    /**
     * Creates new form EditCategorySreen
     */
    public AddCategorySreen() {
        initComponents();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(null, "¿Está seguro de guardar esta categoría?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (option == JOptionPane.YES_OPTION) {
            ...
            Either<String, String> response = new CategoryController().onAdd(categoryModel);
            if (response.isRight()) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCategorySreen().setVisible(true);
            }
        });
    }
